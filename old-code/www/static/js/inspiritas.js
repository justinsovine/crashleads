...
new Highcharts.Chart({
	...
	series: [ {
		pointStart: Date.UTC(2012,10,12),
		pointInterval: 24 * 3600 * 1000, // 1 day
		name: 'Reports Grabbed',
		marker: {
			symbol: 'circle'
		},
		// Just some random data. Replace this with your own.
		data: [4, 5, 8, 9, 10, 11, 10, 8, 7, 6, 9, 10, 13, 15, 16, 18, 15, 12, 10, 9, 8, 5, 8, 9, 10, 13, 15, 14, 11, 12, 13]
	},{
		pointStart: Date.UTC(2012,10,12),
		pointInterval: 24 * 3600 * 1000, // 1 day
		...
		// Just some random data. Replace this with your own.
		data: [0, 2, 3, 4, 5, 3, 2, 2, 3, 4, 6, 7, 8, 9, 10, 8, 11, 7, 5, 3, 4, 4, 1, 3, 4, 5, 8, 10, 9, 5, 10]
	}]
});
